...
void WS281x_update(void) {
    ...
    for (uint8_t led = 0; led < WS281x_LED_COUNT; led++) {
        ...
        WS281x_ledTempR[led] = WS281x_ledRed[led] * percent / 255;
        WS281x_ledTempG[led] = WS281x_ledGreen[led] * percent / 255;
        WS281x_ledTempB[led] = WS281x_ledBlue[led] * percent / 255;
    }
    WS281x_counter++;
    WS281x_show();
}
